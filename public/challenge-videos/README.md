...
Challenge previews should match the FitPerks UI theme:

- clean, bright, and easy to understand at mobile size
- suitable for professionals and students
- minimal background noise and no heavy filters
- show the actual movement clearly in the first second
- avoid decorative gradients, cluttered overlays, or childish styling
