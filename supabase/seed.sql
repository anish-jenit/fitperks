-- Seed for two organizations with isolation-friendly sample data.
insert into organizations (id, name, slug, organization_code, allowed_email_domains, status)
values
  ('11111111-1111-1111-1111-111111111111', 'Company A', 'company-a', 'COMPANYA2026', array['companya.com'], 'active'),
  ('22222222-2222-2222-2222-222222222222', 'School B', 'school-b', 'SCHOOLB2026', array['schoolb.edu'], 'active')
